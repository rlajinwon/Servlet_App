...
public class DepartmentService {
	...
	public void delete(HttpServletRequest request, ActionForward actionForward) throws Exception{
		...
		DepartmentDTO depatDepartmentDTO = new DepartmentDTO();
		depatDepartmentDTO.setDepartment_id(Long.parseLong(request.getParameter("department_id")));
		int result = departmentDAO.delete(depatDepartmentDTO);
